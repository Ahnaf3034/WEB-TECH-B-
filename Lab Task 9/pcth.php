...
<div class="tb">
        ...
        <button class="btn" type="button" onclick="loadDoc()">CHECK HISTORY.</button>
<br><br>
<table id="demo"></table>
...
function loadDoc() {
  ...
  xhttp.open("GET", "tsh.xml", true);
  xhttp.send();
}
function myFunction(xml) {
  var i;
  var xmlDoc = xml.responseXML;
  var table="<tr><th>Passanger Name</th><th>Payment Method</th><th>Payment Time.</th><th>Amount.</th></tr>";
  var x = xmlDoc.getElementsByTagName("CD");
  for (i = 0; i <x.length; i++) { 
    table += "<tr><td>" +
    x[i].getElementsByTagName("CNAME")[0].childNodes[0].nodeValue +
    "</td><td>" +
    x[i].getElementsByTagName("PM")[0].childNodes[0].nodeValue +
    "</td><td>" +
    x[i].getElementsByTagName("PT")[0].childNodes[0].nodeValue +
    "</td><td>" +
    x[i].getElementsByTagName("AM")[0].childNodes[0].nodeValue +
    "</td></tr>";
  }
