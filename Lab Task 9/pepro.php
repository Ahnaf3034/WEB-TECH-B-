...
<form name="myform" method="post" action="pepro.php" onsubmit="return validateform()">
 <div class="inputb">
               <div>
                   <b>User Name:</b> <input type="text" name="username" size="20px" placeholder="Ahnaf" >
                   </div><br/>
                <div>
                  <b>Email:</b> <input type="text" name="email" size="20px" placeholder="ahnaf@gmail.com" >
                  </div><br/>
                <div>
                  <b>Contact No.:</b> <input type="text" name="cno" size="20px" placeholder="0171112255" >
                  </div><br/>
                <div>
                  <b>Address:</b> <input type="text" name="addr" size="20px" placeholder="Khilkhet,Dhaka" >
                  </div><br/>
                <hr/>
       </div>
                <div>
